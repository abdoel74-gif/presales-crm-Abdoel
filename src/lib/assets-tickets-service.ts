...
export const AssetsTicketsService = {
  ...
  async createTicket(
    ...
    const newTicket: TechTicket = {
      ...
      assetTag,
      handoverId: formData.handoverId,
      assigneeName: formData.assigneeName || 'Adrian Pratama',
      assigneeRole: 'Solutions Architect',
      assigneeEmail: 'adrian.pratama@presales-os.enterprise.io',
      ...
      comments: [
        {
          ...
          authorId: creatorProfile?.id || 'usr_adrian',
  ...
  async addTicketComment(
    ...
    const newComment: TicketComment = {
      id: `cmt_${Date.now()}`,
      ticketId,
      authorId: authorProfile?.id || 'usr_adrian',
      authorName: authorProfile?.name || 'Adrian Pratama',
